...
function App() {
  ...
  return (
    <div
      className="w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat px-5"
      style={{
        backgroundImage: `url(
          ...
          >
            <div className="w-full mb-1">
              <Input
                ...
                onCurrencyChange={(currency) => handleAmount(currency)}
                selectCurrency={from}
                onAmountChange={(amount) => handleAmount(amount)}
              />
            </div>
